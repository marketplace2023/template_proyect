...
import { StockShipmentWeightController } from './stock-shipment-weight.controller';
...
@Module({
  ...
  controllers: [StockShipmentWeightController],
  providers: [StockShipmentWeightService],
})
export class StockShipmentWeightModule {}
