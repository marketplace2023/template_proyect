...
@Entity({ name: 'sale_promotion_customer_rule' })
export class SalePromotionCustomerRule {
  ...
  @ManyToOne(
    () => SaleCoupon,
    (saleCoupon) => saleCoupon.promotionCustomerRules,
  )
  ...
  //Uno a Mucho salePromotionAppliedRule- CUST
  @OneToMany(
    () => SalePromotionAppliedRule,
    (promotionAppliedRule) => promotionAppliedRule.salePromotionCustomerRules,
  )
  public promotionAppliedRuless: SalePromotionAppliedRule;
  //---------------------------------------------------------------------

  @Column({ name: 'customer_group_id', type: 'int' })
  ...
  constructor(data: Partial<SalePromotionCustomerRule>) {
