...
@Entity({ name: 'sale_payment_provider_onboarding_wizard' })
export class SalePaymentProviderOnboardingWizard {
  ...
  constructor(data: Partial<SalePaymentProviderOnboardingWizard>) {
